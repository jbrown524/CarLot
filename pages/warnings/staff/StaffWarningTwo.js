...
export default function StaffWarning2Screen({ navigation }) {
  return (
    <SafeAreaView style={styles.warningTwo}>
      ...
      >
        Issue the <Text style={{ color: "#ff6666" }}>STAFF</Text> member their{" "}
        <Text style={{ color: "#ff6666" }}>second</Text> warning slip. The staff
